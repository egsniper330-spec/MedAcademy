...
// ../../node_modules/.pnpm/@babel+helper-module-imports@7.28.6/node_modules/@babel/helper-module-imports/lib/import-builder.js
var require_import_builder = __commonJS({
  "../../node_modules/.pnpm/@babel+helper-module-imports@7.28.6/node_modules/@babel/helper-module-imports/lib/import-builder.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
...
// ../../node_modules/.pnpm/@babel+helper-module-imports@7.28.6/node_modules/@babel/helper-module-imports/lib/is-module.js
var require_is_module = __commonJS({
  "../../node_modules/.pnpm/@babel+helper-module-imports@7.28.6/node_modules/@babel/helper-module-imports/lib/is-module.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
...
// ../../node_modules/.pnpm/@babel+helper-module-imports@7.28.6/node_modules/@babel/helper-module-imports/lib/import-injector.js
var require_import_injector = __commonJS({
  "../../node_modules/.pnpm/@babel+helper-module-imports@7.28.6/node_modules/@babel/helper-module-imports/lib/import-injector.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
...
// ../../node_modules/.pnpm/@babel+helper-module-imports@7.28.6/node_modules/@babel/helper-module-imports/lib/index.js
var require_lib4 = __commonJS({
  "../../node_modules/.pnpm/@babel+helper-module-imports@7.28.6/node_modules/@babel/helper-module-imports/lib/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", {
      value: true
    });
    ...
    exports2.addDefault = addDefault2;
...
// src/babel/plugin-lucide-react-native.ts
var plugin_lucide_react_native_exports = {};
__export(plugin_lucide_react_native_exports, {
  default: () => lucideReactNativePlugin
});
module.exports = __toCommonJS(plugin_lucide_react_native_exports);
  ...
  return {
    ...
    visitor: {
      Program: {
        // 每个文件独立处理，重置所有文件级状态
        enter() {
          selectedIcons = /* @__PURE__ */ Object.create(null);
          specifiedLocal4Imported = /* @__PURE__ */ Object.create(null);
          removablePaths = [];
        },
        // 统一在最后移除所有占位的 null literal 节点
        exit() {
          removablePaths.filter((p) => !p.removed).forEach((p) => p.remove());
        }
      },
      // 拦截 `import { Star, BookHeart as BH } from "lucide-react-native"`
      // 记录本地名到原始图标名的映射，再将整条 import 声明替换为占位节点（稍后移除）
      ImportDeclaration(nodePath) {
        if (nodePath.node.source.value !== LUCIDE_REACT_NATIVE) return;
        nodePath.node.specifiers.forEach((spec) => {
          if (t.isImportSpecifier(spec) && t.isIdentifier(spec.imported)) {
            specifiedLocal4Imported[spec.local.name] = spec.imported.name;
          } else {
            throw new Error(
              `Only named identifier imports are supported by babel-plugin-${LUCIDE_REACT_NATIVE}`
            );
          }
        });
        nodePath.replaceWith(t.nullLiteral());
        removablePaths.push(nodePath);
      },
      // 拦截 `export { Star, BookHeart as BHIcon } from "lucide-react-native"`
      ...
      ExportNamedDeclaration(nodePath, state) {
        ...
        node.specifiers.forEach((spec) => {
          if (t.isExportNamespaceSpecifier(spec) || t.isExportDefaultSpecifier(spec)) {
            throw new Error(
              `Only named identifier exports are supported by babel-plugin-${LUCIDE_REACT_NATIVE}`
            );
          }
      ...
      // `export * from "lucide-react-native"` 会把整个库导出，完全抵消 tree-shaking 效果
      ExportAllDeclaration(nodePath) {
        if (nodePath.node.source.value === LUCIDE_REACT_NATIVE) {
          throw new Error(
...
//# sourceMappingURL=plugin-lucide-react-native.js.map